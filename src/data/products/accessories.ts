...
export const accessorySkus: AccessorySku[] = [
  {
    ...
    description: "Accesorios esenciales que incluyen adaptadores de video, cables de alta velocidad y soluciones de almacenamiento. Mejora tu experiencia Openterface con equipo de calidad de la tienda TxA Shop.",
...
export const accessoriesProduct: Product = {
  ...
  seoDescription:
    "Accesorios Openterface: cables, adaptadores, bolsas de herramientas y conectores de video.",
  ...
  painPoints: [
    "No tener el cable adecuado en el campo retrasa cada reparación",
  ],
  solutions: [
    "Accesorios seleccionados y probados con productos Openterface",
  ],
  hwFeatures: [
  ...
  useCases: [
    "Organización de kits de campo",
    "Conversión de formatos de video",
    "Cables de repuesto para mochilas de TI",
  ],
  useCaseCards: [
    {
  ...
  docLinks: [
    ...
    { label: "Tienda TxA", href: docsPath("https://shop.techxartisan.com") },
  ],
